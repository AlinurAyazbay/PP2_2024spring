...
pygame.mixer.Sound('lab9/race/Lab8_Racer_background.wav').play()

background = pygame.image.load("lab9/race/AnimatedStreet.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab9/race/Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('lab9/race/Lab8_Racer_crash.wav').play()
        time.sleep(1)
